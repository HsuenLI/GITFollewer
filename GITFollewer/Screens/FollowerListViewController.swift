...
class FollowerListViewController: GFDataLoadingVC {
    ...
    var isLoadingForMoreFollowers = false
    ...
    func getFollowers(username: String, page: Int) {
        showLoadingView()
        isLoadingForMoreFollowers = true
        ...
        NetworkManager.shared.getFollowers(for: username, page: page) { [weak self] result in
            ...
            self.isLoadingForMoreFollowers = false
        }
    }
...
extension FollowerListViewController: UICollectionViewDelegate {
    ...
    func scrollViewDidEndDragging(_ scrollView: UIScrollView, willDecelerate decelerate: Bool) {
        ...
        if offsetY > contentHeight - height {
            guard hasMoreFollowers, !isLoadingForMoreFollowers else { return }
            page += 1
            getFollowers(username: username, page: page)
        }
    }
